...
func (m *PipelineService) Update(arg0 context.Context, arg1 *pipeline.Instance, arg2 pipeline.Config) (*pipeline.Instance, error) {
	m.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *ConnectorServiceMockRecorder) List(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Create mocks base method.
func (m *ProcessorService) Create(arg0 context.Context, arg1, arg2 string, arg3 processor.Type, arg4 processor.Parent, arg5 processor.Config) (*processor.Instance, error) {
	m.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *ProcessorServiceMockRecorder) List(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
