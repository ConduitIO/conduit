...
var (
	...
	ErrPipelineInvalidTopology = cerrors.New("pipeline topology is invalid")
	ErrPipelineNoSourceConnectors = cerrors.New("can't build pipeline without any source connectors")
	ErrPipelineNoDestinationConnectors = cerrors.New("can't build pipeline without any destination connectors")
	ErrPipelineInvalidDLQConfig = cerrors.New("invalid DLQ configuration")
)
