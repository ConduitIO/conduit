...
//
//	mockgen -typed -source=service.go -destination=mock/source_interface_mocks.go -package=mock -mock_names=builtinReg=BuiltinReg,standaloneReg=StandaloneReg,authManager=AuthManager . builtinReg,standaloneReg,authManager
//
...
type AuthManager struct {
	ctrl     *gomock.Controller
	recorder *AuthManagerMockRecorder
	isgomock struct{}
}
...
func NewAuthManager(ctrl *gomock.Controller) *AuthManager {
	mock := &AuthManager{ctrl: ctrl}
	mock.recorder = &AuthManagerMockRecorder{mock}
	return mock
}
...
func (m *AuthManager) Deregister(token string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Deregister", token)
}

// Deregister indicates an expected call of Deregister.
func (mr *AuthManagerMockRecorder) Deregister(token any) *AuthManagerDeregisterCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Deregister", reflect.TypeOf((*AuthManager)(nil).Deregister), token)
	return &AuthManagerDeregisterCall{Call: call}
}

// AuthManagerDeregisterCall wrap *gomock.Call
type AuthManagerDeregisterCall struct {
	*gomock.Call
}
...
func (m *AuthManager) GenerateNew(connectorID string) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateNew", connectorID)
	ret0, _ := ret[0].(string)
	return ret0
}
...
func (mr *AuthManagerMockRecorder) GenerateNew(connectorID any) *AuthManagerGenerateNewCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateNew", reflect.TypeOf((*AuthManager)(nil).GenerateNew), connectorID)
	return &AuthManagerGenerateNewCall{Call: call}
}

// AuthManagerGenerateNewCall wrap *gomock.Call
type AuthManagerGenerateNewCall struct {
	*gomock.Call
}
