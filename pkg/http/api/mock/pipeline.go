...
//
//	mockgen -typed -destination=mock/pipeline.go -package=mock -mock_names=PipelineOrchestrator=PipelineOrchestrator,Provisioner=Provisioner . PipelineOrchestrator,Provisioner
//
