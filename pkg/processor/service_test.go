...
func TestService_Init_Success(t *testing.T) {
	...
	_, err := service.Create(ctx, uuid.NewString(), name, processor.Parent{}, processor.Config{}, processor.TypeAPI)
	assert.Ok(t, err)
...
func TestService_Create_Success(t *testing.T) {
	...
	got, err := service.Create(ctx, want.ID, want.Name, want.Parent, want.Config, processor.TypeAPI)
	assert.Ok(t, err)
...
func TestService_Delete_Success(t *testing.T) {
	...
	// create a processor instance
	i, err := service.Create(ctx, uuid.NewString(), name, processor.Parent{}, processor.Config{}, processor.TypeAPI)
	assert.Ok(t, err)
...
func TestService_Get_Success(t *testing.T) {
	...
	// create a processor instance
	want, err := service.Create(ctx, uuid.NewString(), name, processor.Parent{}, processor.Config{}, processor.TypeAPI)
	assert.Ok(t, err)
...
func TestService_List_Some(t *testing.T) {
	...
	i1, err := service.Create(ctx, uuid.NewString(), name, processor.Parent{}, processor.Config{}, processor.TypeAPI)
	assert.Ok(t, err)
	i2, err := service.Create(ctx, uuid.NewString(), name, processor.Parent{}, processor.Config{}, processor.TypeAPI)
	assert.Ok(t, err)
	i3, err := service.Create(ctx, uuid.NewString(), name, processor.Parent{}, processor.Config{}, processor.TypeAPI)
	assert.Ok(t, err)
