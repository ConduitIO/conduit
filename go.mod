...
require (
	buf.build/gen/go/grpc-ecosystem/grpc-gateway/protocolbuffers/go v1.34.2-20240524201210-f04e50c23f5f.1
	...
	github.com/conduitio/conduit-connector-postgres v0.7.3
