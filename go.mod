...
require (
	...
	github.com/conduitio/conduit-connector-file v0.6.1-0.20240719142309-a83cd31e4cda
	...
	github.com/conduitio/conduit-connector-sdk v0.9.2-0.20240719191008-f84e096f42f6
