...
require (
	buf.build/gen/go/grpc-ecosystem/grpc-gateway/protocolbuffers/go v1.30.0-20230607214310-11c9972ea0fd.1
	...
	github.com/meroxa/conduit-connector-spire-ais v0.2.0
