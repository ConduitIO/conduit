...
require (
	...
	github.com/conduitio/conduit-commons v0.2.1-0.20240529133748-8cae36becb39
	...
	github.com/conduitio/conduit-connector-protocol v0.6.1-0.20240529170440-32b3fb1d033c
