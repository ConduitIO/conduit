...
require (
	buf.build/gen/go/grpc-ecosystem/grpc-gateway/protocolbuffers/go v1.34.1-20240523202356-fff35d47bf31.1
	...
	github.com/conduitio/conduit-connector-protocol v0.6.1-0.20240528133330-3ab0cf9ad6d6
	github.com/conduitio/conduit-connector-s3 v0.5.1
	github.com/conduitio/conduit-connector-sdk v0.9.2-0.20240528131406-2bb38375e679
