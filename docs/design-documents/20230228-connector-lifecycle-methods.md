...
Each connector would specify a list of events it accepts and the corresponding
...
In the SDK we can still provide utilities for parsing the parameters and
