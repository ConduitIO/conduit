...
func (c *pipelineServiceClient) GetDLQ(ctx context.Context, in *GetDLQRequest, opts ...grpc.CallOption) (*GetDLQResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineService_GetDLQ_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineServiceClient) UpdateDLQ(ctx context.Context, in *UpdateDLQRequest, opts ...grpc.CallOption) (*UpdateDLQResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineService_UpdateDLQ_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineServiceClient) ExportPipeline(ctx context.Context, in *ExportPipelineRequest, opts ...grpc.CallOption) (*ExportPipelineResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineService_ExportPipeline_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineServiceClient) ImportPipeline(ctx context.Context, in *ImportPipelineRequest, opts ...grpc.CallOption) (*ImportPipelineResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineService_ImportPipeline_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorServiceClient) ListConnectors(ctx context.Context, in *ListConnectorsRequest, opts ...grpc.CallOption) (*ListConnectorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConnectorService_ListConnectors_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorServiceClient) InspectConnector(ctx context.Context, in *InspectConnectorRequest, opts ...grpc.CallOption) (ConnectorService_InspectConnectorClient, error) {
	stream, err := c.cc.NewStream(ctx, &ConnectorService_ServiceDesc.Streams[0], ConnectorService_InspectConnector_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &connectorServiceInspectConnectorClient{stream}
...
func (c *connectorServiceClient) GetConnector(ctx context.Context, in *GetConnectorRequest, opts ...grpc.CallOption) (*GetConnectorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConnectorService_GetConnector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorServiceClient) CreateConnector(ctx context.Context, in *CreateConnectorRequest, opts ...grpc.CallOption) (*CreateConnectorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConnectorService_CreateConnector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorServiceClient) ValidateConnector(ctx context.Context, in *ValidateConnectorRequest, opts ...grpc.CallOption) (*ValidateConnectorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConnectorService_ValidateConnector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorServiceClient) UpdateConnector(ctx context.Context, in *UpdateConnectorRequest, opts ...grpc.CallOption) (*UpdateConnectorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConnectorService_UpdateConnector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *connectorServiceClient) DeleteConnector(ctx context.Context, in *DeleteConnectorRequest, opts ...grpc.CallOption) (*DeleteConnectorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConnectorService_DeleteConnector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConnectorService_InspectConnector_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ConnectorServiceServer).InspectConnector(m, &connectorServiceInspectConnectorServer{stream})
}
...
func (c *processorServiceClient) ListProcessors(ctx context.Context, in *ListProcessorsRequest, opts ...grpc.CallOption) (*ListProcessorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessorService_ListProcessors_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processorServiceClient) InspectProcessorIn(ctx context.Context, in *InspectProcessorInRequest, opts ...grpc.CallOption) (ProcessorService_InspectProcessorInClient, error) {
	stream, err := c.cc.NewStream(ctx, &ProcessorService_ServiceDesc.Streams[0], ProcessorService_InspectProcessorIn_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *processorServiceClient) InspectProcessorOut(ctx context.Context, in *InspectProcessorOutRequest, opts ...grpc.CallOption) (ProcessorService_InspectProcessorOutClient, error) {
	stream, err := c.cc.NewStream(ctx, &ProcessorService_ServiceDesc.Streams[1], ProcessorService_InspectProcessorOut_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *processorServiceClient) GetProcessor(ctx context.Context, in *GetProcessorRequest, opts ...grpc.CallOption) (*GetProcessorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessorService_GetProcessor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processorServiceClient) CreateProcessor(ctx context.Context, in *CreateProcessorRequest, opts ...grpc.CallOption) (*CreateProcessorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessorService_CreateProcessor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processorServiceClient) UpdateProcessor(ctx context.Context, in *UpdateProcessorRequest, opts ...grpc.CallOption) (*UpdateProcessorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessorService_UpdateProcessor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processorServiceClient) DeleteProcessor(ctx context.Context, in *DeleteProcessorRequest, opts ...grpc.CallOption) (*DeleteProcessorResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProcessorService_DeleteProcessor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *informationServiceClient) GetInfo(ctx context.Context, in *GetInfoRequest, opts ...grpc.CallOption) (*GetInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, InformationService_GetInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
