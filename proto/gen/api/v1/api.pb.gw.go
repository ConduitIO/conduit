...
func request_PipelineService_GetDLQ_0(ctx context.Context, marshaler runtime.Marshaler, client PipelineServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDLQRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetDLQ(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PipelineService_GetDLQ_0(ctx context.Context, marshaler runtime.Marshaler, server PipelineServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDLQRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetDLQ(ctx, &protoReq)
	return msg, metadata, err

}

func request_PipelineService_UpdateDLQ_0(ctx context.Context, marshaler runtime.Marshaler, client PipelineServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateDLQRequest
	var metadata runtime.ServerMetadata
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.Dlq); err != nil && err != io.EOF {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	...
	msg, err := client.UpdateDLQ(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PipelineService_UpdateDLQ_0(ctx context.Context, marshaler runtime.Marshaler, server PipelineServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateDLQRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateDLQ(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterPipelineServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelineServiceServer) error {
	...
	mux.Handle("GET", pattern_PipelineService_GetDLQ_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.PipelineService/GetDLQ", runtime.WithHTTPPathPattern("/v1/pipelines/{id}/dead-letter-queue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelineService_GetDLQ_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelineService_GetDLQ_0(annotatedContext, mux, outboundMarshaler, w, req, response_PipelineService_GetDLQ_0{resp}, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PUT", pattern_PipelineService_UpdateDLQ_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.PipelineService/UpdateDLQ", runtime.WithHTTPPathPattern("/v1/pipelines/{id}/dead-letter-queue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PipelineService_UpdateDLQ_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PipelineService_UpdateDLQ_0(annotatedContext, mux, outboundMarshaler, w, req, response_PipelineService_UpdateDLQ_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterPipelineServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelineServiceClient) error {
	...
	mux.Handle("GET", pattern_PipelineService_GetDLQ_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.v1.PipelineService/GetDLQ", runtime.WithHTTPPathPattern("/v1/pipelines/{id}/dead-letter-queue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelineService_GetDLQ_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_PipelineService_UpdateDLQ_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.v1.PipelineService/UpdateDLQ", runtime.WithHTTPPathPattern("/v1/pipelines/{id}/dead-letter-queue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PipelineService_UpdateDLQ_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_PipelineService_GetDLQ_0 struct {
	proto.Message
}

func (m response_PipelineService_GetDLQ_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetDLQResponse)
	return response.Dlq
}

type response_PipelineService_UpdateDLQ_0 struct {
	proto.Message
}

func (m response_PipelineService_UpdateDLQ_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*UpdateDLQResponse)
	return response.Dlq
}
...
var (
	...
	pattern_PipelineService_GetDLQ_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "pipelines", "id", "dead-letter-queue"}, ""))

	pattern_PipelineService_UpdateDLQ_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "pipelines", "id", "dead-letter-queue"}, ""))
...
var (
	...
	forward_PipelineService_GetDLQ_0 = runtime.ForwardResponseMessage

	forward_PipelineService_UpdateDLQ_0 = runtime.ForwardResponseMessage
